...
public class Brew {
	...
	public Brew(int brewID, String name, int userID, String userName, String userSurname, int recipeID,
			String recipeName, Date brewDate, String description, int quantity, String tasteNote) {
		super();
		this.brewID = brewID;
		this.name = name;
		this.userID = userID;
