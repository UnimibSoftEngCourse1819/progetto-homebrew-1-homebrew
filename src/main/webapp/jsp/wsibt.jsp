		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-body">
					<div class="modal_field modal_Bname">
						<h6>Nome</h6>
						<p></p>
					</div>
					<div class="modal_field modal_Buser">
						<h6>Brewer</h6>
						<p></p>
					</div>
					<div class="modal_field modal_Bdate">
						<h6>Data</h6>
						<p></p>
					</div>
					<div class="modal_field modal_Bquantity">
						<h6>Quantita'</h6>
						<p></p>
					</div>
					<div class="modal_field modal_Bdesc">
						<h6>Descrizione</h6>
						<p></p>
					</div>
					<div class="modal_field modal_Bnote">
						<h6>Nota di degustazione</h6>
						<p></p>
					</div>
				</div>
			</div>
