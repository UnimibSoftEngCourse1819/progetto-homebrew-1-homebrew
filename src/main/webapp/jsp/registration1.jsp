	...
	<div id="page" class="container">
		...
		<div id="main">
			...
			<div id="featured">
				<ul class="style1">
					<li class="first">
						<form action="../AddUser" method="post" name="registration_form">
							<table>
								<tr>
									<td><h3>Nome:</h3></td>
									<td><h3>
								...
								<tr>
									...
									<td><h3>
											<input name="checkPassword" type="password" required>
										</h3>
								</tr>
								<tr>
							...
							<input name="action" type="submit"
								value="ISCRIVITI" id="addNewUser" onClick ="return(controlForm ());">
